...
### Corporate Identity (NVIDIA)

**Fonts**:

- **Headings**: `NVIDIA Sans Medium` (Fallback: `Arial`)
- **Body**: `NVIDIA Sans` (Fallback: `Arial`)

**Color Palette**:

- **Primary Brand (Green)**: `#76B900`
- **Background**: `#FFFFFF` (White)
- **Text**: `#000000` (Black) or `#5E5E5E` (Dark Gray)
- **Accents**:
  - Teal: `#008564`
  - Purple: `#5D1682`
  - Magenta: `#890C58`
...
**ONLY use web-safe fonts that are universally available (unless using Corporate Fonts):**

- ✅ Corporate: `NVIDIA Sans`, `NVIDIA Sans Medium` (Must be installed on viewer's machine)
- ✅ Web-safe: `Arial`, `Helvetica`, `Times New Roman`, `Georgia`, `Courier New`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`
...
- **NATIVE SHAPES (PREFERRED)**: For editable flowcharts, do NOT use html2pptx. Instead, write a script using PptxGenJS native Shape API. See [FLOWCHARTS.md](references/FLOWCHARTS.md).
- **HTML Layout**: If you must use html2pptx, simulate the flowchart using Flexbox/Grid and CSS borders, but be aware that connectors will be static.
